...
require (
	...
	github.com/lukaszkaleta/saas-go/database/pg v0.1.44
	github.com/lukaszkaleta/saas-go/filestore v0.1.44
	github.com/lukaszkaleta/saas-go/filestore/pg v0.1.44
	github.com/lukaszkaleta/saas-go/offer v0.1.43
	github.com/lukaszkaleta/saas-go/universal v0.1.44
	github.com/lukaszkaleta/saas-go/universal/pg v0.1.44
)
