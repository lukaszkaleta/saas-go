...
func CreatedByIds[T ActionsAwareModel](ctx context.Context, instance []any) ([]int64, error) {
	ids := make([]int64, len(instance))
	for i := range instance {
		id, err := CreatedById[T](ctx, instance[i])
		if err != nil {
			return nil, err
		}
		ids[i] = id
...
func CreatedByIdFromModel[T ActionsAwareModel](model T) *int64 {
...
func CreatedByIdFromModels[T ActionsAwareModel](models []*T) []*int64 {
