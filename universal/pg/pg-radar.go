...
func (r *PgRadar) Update(model *universal.RadarModel) error {
	...
	_, err := r.Db.Pool.Exec(context.Background(), query, model.Perimeter, model.Position.Lat, model.Position.Lon, r.TableEntity.Id)
	if err != nil {
		return err
	}
	return nil
...
func (r *PgRadar) Model() *universal.RadarModel {
