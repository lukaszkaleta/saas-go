...
require (
	...
	github.com/lukaszkaleta/saas-go/database/pg v0.1.30
	github.com/lukaszkaleta/saas-go/filestore v0.1.30
	github.com/lukaszkaleta/saas-go/universal v0.1.30
	github.com/lukaszkaleta/saas-go/universal/pg v0.1.30
)
