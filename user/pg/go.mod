...
require (
	...
	github.com/lukaszkaleta/saas-go/filestore v0.2.82
	github.com/lukaszkaleta/saas-go/filestore/pg v0.2.82
	github.com/lukaszkaleta/saas-go/universal v0.2.82
	github.com/lukaszkaleta/saas-go/universal/pg v0.2.82
