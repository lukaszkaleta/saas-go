...
require (
	...
	github.com/lukaszkaleta/saas-go/filestore/pg v0.2.304
	github.com/lukaszkaleta/saas-go/job v0.2.304
	github.com/lukaszkaleta/saas-go/messages v0.2.304
	github.com/lukaszkaleta/saas-go/messages/pg v0.2.304
	github.com/lukaszkaleta/saas-go/payment v0.2.304
	github.com/lukaszkaleta/saas-go/payment/pg v0.2.304
	github.com/lukaszkaleta/saas-go/universal v0.2.304
	github.com/lukaszkaleta/saas-go/universal/pg v0.2.304
